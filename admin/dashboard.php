...
<head>
	...
	<title>DocMall | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed Doctors</div>
												</div>
											</div>
											<a href="manage-doctors.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT id from profession ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Listed Profession</div>
												</div>
											</div>
											<a href="manage-profession.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
