...
<title>DocMall | Doctor Details</title>
<!--Bootstrap -->
...
$sql = "SELECT doctors.*,profession.BrandName,profession.id as bid  from doctors join profession on profession.id=doctors.VehiclesBrand where doctors.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>R<?php echo htmlentities($result->PricePerDay);?> </p>Per Day
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Doctor Address </a></li>
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="text" class="form-control" name="fromdate" placeholder="Appointment Date" required>
            </div>
